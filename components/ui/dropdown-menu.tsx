...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[11rem] overflow-hidden rounded-xl border border-border bg-white p-1.5 text-sm shadow-elevated animate-fade-in",
        className
      )}
      {...props}
    />
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive ? "text-rose-600 focus:bg-rose-50" : "text-foreground",
      className
    )}
    {...props}
  />
